...
public class TC_SignUpWithVerifiedUsername extends BasePage {
	...
	public void testSignUp() throws Exception {
		...
		signUp.enteringValuesForSignup(19);

		logger.info("Click on the SignUp button");
		signUp.saveBtn();
		sleep(2);

		logger.info("Will be showing toast message for Username as it is already registered and verified.");
