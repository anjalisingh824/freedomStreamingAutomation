...
public class TC_AddAnnouncement {

	public WebDriver driver;
	public WebDriver adminDriver;
	private Logger logger = Logger.getLogger(TC_AddAnnouncement.class);
	...
	public void testCheckFortheAddedAnnouncementFromAdmin() {
		logger.info("===Test execution started for checking the Added Announcement from the Admin Side===");
		...
		logger.info("===Test execution ended for checking the Added Announcement from the Admin Side===");
